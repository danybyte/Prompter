export function getSystemInstruction(): string {
  ...
  You must tailor your final prompt's structure, instructions, and features specifically to utilize Gemini's strengths: emphasize system instructions, XML structure tags, clear roles, tool use, and @google/genai schema style cues.
  ...
  9. If isCompleted is true, compile the ultimate Prompt in "finalPrompt". This must be a highly robust, self-contained, and comprehensive instructions template ready to copy-paste into Gemini.
